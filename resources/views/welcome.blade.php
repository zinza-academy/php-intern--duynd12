        ...
        <div class="flex min-h-full h-screen flex-col items-center justify-center bg-[#F5F5F5]">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form class="space-y-6" action="{{route('login')}}" method="POST">
                ...
                <div> 
                  <button type="submit" class="w-96 h-10 decoration-white font-medium text-sm
              ...
              <div>
                <div>
                    <button type="" class="w-96 h-10 border-2 mt-10 rounded font-normal text-sm flex items-center justify-center bg-[#f7f8fa]">
              ...
              <div>
                <div>
                    <button type="" class="w-96 h-10 border-2 mt-4 rounded flex items-center justify-center bg-[#f7f8fa]">
