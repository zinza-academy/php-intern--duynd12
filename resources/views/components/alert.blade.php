    ...
    @foreach($data as $user)
      <tr class="h-10 border-2" style="">
        ...
        <td class="h-10 w-10 pr-4">
            <img src="{{URL::asset('images/threedots.png')}}" id="dropdownDefaultButton" data-dropdown-toggle="dropdown.{{$user->id}}" >
        </td>
        <div id="dropdown.{{$user->id}}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
              ...
              <li>
                <a type="button" data-modal-target="staticModal" data-modal-toggle="staticModal.{{$user->id}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Delete</a>
              </li>
            </ul>
        </div>
