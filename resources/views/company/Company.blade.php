...
<div class="">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <th scope="col" class="px-6 py-3 flex">
                    ...
                    {{-- <form action="" method="GET">
                            @if($param == \App\Constants\StatusConstants::DESC)
                                <input name="active" value="{{\App\Constants\StatusConstants::ASC}}" hidden/>
                                <button type="submit">
                                    <img type="submit" style="height: 16px;width:16px;margin-left:10px" src="{{URL::asset('images/down.png')}}" alt="">
                                </button>
                            @else
                                <input name="active" value="{{\App\Constants\StatusConstants::DESC}}" hidden/>
                                <button type="submit">
                                    <img type="submit" style="height: 16px;width:16px;margin-left:10px" src="{{URL::asset('images/up-arrow.png')}}" alt="">
                                </button>
                            @endif
                        </form> --}}
                </th>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 h-28">
                <th class="w-4 p-4">
                    @if(count($company['users']) > 0)
                    <div class="flex">
                        <img class="h-10 w-10" src="{{URL::asset('storage/images/logo/').'/'.$company['users'][0]['profiles']['avatar']}}" alt="Error">
                        <div class="pl-4">
                ...
                <td class="px-6 py-4" style="height:10px;width:80px">
                    <img src="{{URL::asset('images/threedots.png')}}" style="width:20px" id="dropdownDefaultButton" data-dropdown-toggle="dropdown.{{$company->id}}" >
                </td>
